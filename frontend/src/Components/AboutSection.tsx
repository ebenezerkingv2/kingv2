...
const AboutSection = () => {
	return (
		<section className="aboutSection relative flex-1 md:bg-black text-[#dbcfff] w-full overflow-hidden">
			...
			{/* ============================== HERO CONTENT */}
			<div className="aboutSection__mobile--hero-content relative z-20 h-screen grid grid-rows-[auto_1fr_auto] px-4 md:h-auto md:mx-auto md:md:w-[90%] lg:w-[60%]">
				{/* ============================== ABOUT HEADER */}
				...
				{/* ============================== ABOUT CONTENT */}
				<div className="servicesSection__paragraphs mx-auto flex flex-col gap-4 lg:gap-3 text-[1.2rem] self-center md:my-[4rem]">
					<p className="w-fit bg-black/50 backdrop-blur-sm md:border md:border-orange-500 rounded-[1rem] md:rounded-[0.5rem] px-4 py-[0.1rem] md:py-[0.2rem] ">
