...
function Footer() {
	...
	return (
		<motion.footer
			...
			className="footer__parent bg-[#f6f0ec] text-[#450693] w-full text-[1.1rem] py-[1rem] px-[1rem] flex flex-col lg:px-[2rem]md:text-[1.2rem] lg:text-[1.1rem]"
		>
			{/* =============== Contact Section =============== */}
			<div className="footer__contact flex flex-col items-end">
				...
				<a href="https://wa.me/message/UHRWC3UBMMB2E1">
					<FaWhatsappSquare size={40} className="hover:bg-[#dbcfff]" />
				</a>
			</div>

			{/* =============== Social Icons + Copyright =============== */}
			<div className="flex flex-col gap-2 mt-[1rem] lg:flex-row lg:justify-between">
				<nav>
					<ul>
						<li className="flex gap-2">
							<a
								...
								aria-label="Twitter"
							>
								<span className="inline-flex items-center justify-center p-2 border border-transparent hover:bg-[#dbcfff] rounded transition-all duration-300">
